...
urlpatterns = [
    ...
    path('analytical-strategy/', views.analytical_strategy_view, name='analytical_strategy'),
    # Common routes
    path('behavioral-resume-live/', views.behavioral_resume_live_view, name='behavioral_resume_live'),
