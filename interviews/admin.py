...
class InterviewSessionAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Final Analysis", {"fields": ("overall_readiness_score", "final_analysis")}),
...
class CodingRoundAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Session", {"fields": ("session", "question_number")}),
        (
            "Question Data",
            {
                "fields": (
        ...
        ("User Submission", {"fields": ("language", "user_code", "evaluation_result")}),
        ("Timestamps", {"fields": ("created_at", "updated_at")}),
    )
...
class SystemDesignRoundAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Question Data", {"fields": ("base_question", "generated_question")}),
        ("User Submission", {"fields": ("user_answer", "evaluation_result")}),
        ("Timestamps", {"fields": ("created_at", "updated_at")}),
    )
...
class ProductSenseRoundAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Session", {"fields": ("session",)}),
        ("Case Data", {"fields": ("base_case", "generated_case")}),
        ("User Submission", {"fields": ("user_answer", "evaluation_result")}),
        ("Timestamps", {"fields": ("created_at", "updated_at")}),
    )
