...
class CompanyDocumentAdmin(admin.ModelAdmin):
    ...
    readonly_fields = ('status', 'error_message', 'created_at', 'updated_at', 'extracted_text_preview')
    ...
    def save_model(self, request, obj, form, change):
        ...
        if is_new or file_changed:
            try:
                ...
                messages.success(request, f'Successfully extracted {len(full_text)} characters from PDF.')
