    ...
    class Meta:
        ...
        widgets = {
            "title": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "Enter topic title..."}
            ),
        }
...
class PostForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            "is_case_study": forms.CheckboxInput(attrs={"class": "form-check-input"}),
            "is_preparation_strategy": forms.CheckboxInput(
