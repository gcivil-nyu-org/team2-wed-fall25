...
class Forum(models.Model):
    ...
    description = models.TextField(help_text="Brief description of what this forum is about")
    ...
    def latest_activity(self):
        latest_post = Post.objects.filter(topic__forum=self).order_by('-created_at').first()
        if latest_post:
...
class Topic(models.Model):
    ...
    description = models.TextField(help_text="Initial post content or topic description")
    author = models.ForeignKey(User, on_delete=models.CASCADE, related_name='topics_created')
    is_pinned = models.BooleanField(default=False, help_text="Pin important topics to the top")
    is_locked = models.BooleanField(default=False, help_text="Lock to prevent new replies")
...
class Post(models.Model):
    ...
    is_preparation_strategy = models.BooleanField(
        default=False,
        help_text="Mark as a preparation strategy tip"
    )
...
class MentorAssignment(models.Model):
    ...
    mentor = models.ForeignKey(User, on_delete=models.CASCADE, related_name='mentored_forums')
